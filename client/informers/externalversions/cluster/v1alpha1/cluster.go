...
import (
	...
	internalinterfaces "go.bytebuilders.dev/crd-learner-template/client/informers/externalversions/internalinterfaces"
	v1alpha1 "go.bytebuilders.dev/crd-learner-template/client/listers/cluster/v1alpha1"
