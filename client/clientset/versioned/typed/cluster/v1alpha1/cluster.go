...
import (
	...
	v1alpha1 "go.bytebuilders.dev/crd-learner-template/apis/cluster/v1alpha1"
	scheme "go.bytebuilders.dev/crd-learner-template/client/clientset/versioned/scheme"
